    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex flex-wrap items-center gap-4">
                ...
                <InputField label="Start time" error={errors?.startTime} name="startTime" defaultValue={data?.startTime} register={register} />
                <InputField label="End time" error={errors?.endTime} name="endTime" defaultValue={data?.endTime} register={register} />
                </div>
