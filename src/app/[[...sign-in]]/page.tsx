...
const LoginPage = () => {
    ...
    return <div className="h-screen flex items-center justify-center bg-lamaSkyLight">
        <SignIn.Root>
            <SignIn.Step name='start' className="bg-white p-12 rounded-md shodow-2xl flex flex-col gap-2">
                ...
                <Clerk.Field name='identifier' className="flex flex-col gap-2">
                    <Clerk.Label className='text-sm text-gray-400'>Username</Clerk.Label>
